    ...
    <>
      <div id="containerFooter1">
        ...
        <div id="informazioni1">
          ...
          <select id="privacyEcondizioni1" name="privacy">
            ...
            <option value="termini e condizioni">
        ...
        <div id="lingua1">
          ...
          <div className="lastDiv1">
            <p id="copyright1">Linkedin Corporation &copy; 2024</p>
          </div>
        </div>
      </div>
    </>
