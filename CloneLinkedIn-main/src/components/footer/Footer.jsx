      ...
      <>
          <div id="containerFooter">
              <div id="informazioni">
                ...
                <p><a href="">Accessibilità</a></p>
                <p><a href="">Talent Solutions</a></p>
                <p><a href="">Linee guida della community</a></p>
                <p><a href="">Carriera</a></p>
                <p><a href="">Soluzioni di marketing</a></p>
                <select id="privacyEcondizioni" name="privacy">
                  <option value="PeC">Privacy e condizioni</option>
                  <option value="privacy">Informativa sulla privacy</option>
                  <option value="licenza">Contratto di licenza</option>
                  <option value="termini e condizioni">Termini e condizioni delle pagine</option>
                  <option value="cookie">Informativa sui cookie</option>
                  <option value="copyright">Informativa sul copyright</option>
                </select>
                <p><a href="">Opzioni per gli annunci <br /> pubblicitari</a></p>
              ...
              <div id="lingua">
                <label htmlFor="lingua">Seleziona lingua</label>
                <select id="lingue" name="lingua">
                <option value="italiano">Italiano (Italiano)</option>
                <option value="inglese">English (Inglese)</option>
                <option value="spagnolo">Espanol (Spagnolo)</option>
                <option value="francese">Francais (Francese)</option>
                </select>
              </div>
           </div>
            <div>
                <p id="copyright">Linkedin Corporation &copy; 2024</p>
            </div>
      </>
  );
};
